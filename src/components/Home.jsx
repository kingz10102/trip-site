    ...
    return (
        <div className="home">
          ...
          <Card
                ...
                title="Havana, Cuba"
                description="Start exploring the homes of famous Cuban residents, relaxing on beaches, soaking in the art"
                price="$200/night"
            />
            <Card
                ...
                title="Labadee, Haiti"
                description="Cruise to Labadee and trek to the mountaintop to catch serious air on the world's great seas."
                price="$350/night"
            />
            <Card
